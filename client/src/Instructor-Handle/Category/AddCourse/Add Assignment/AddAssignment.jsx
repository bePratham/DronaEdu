 ...
 return (
  <div className={style.Container}>
    ...
    <form onSubmit={handleSubmit}>
      ...
      <h2 style={{fontWeight:'700',fontSize:'50px'}}>Add Assignment</h2>    
      ...
      <input className={style.input}  type="date" id="dueDate" name="dueDate" onChange={handleChange} />

      <label htmlFor="points">Points</label>
      <input className={style.input}  type="number" id="points" name="points" onChange={handleChange} />
